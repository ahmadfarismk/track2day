        ...
        <div class="tasks-container">
            ...
            <form action="updateTask.php" method="POST">
                ...
                <div>
                    ...
                    <input type="date" id="task_duration" name="task_duration" value="<?php echo htmlspecialchars($task['task_duration']); ?>" required>
                </div>
                <div>
                    <label for="task_desc">Task Description:</label>
                    <input type="text" id="task_desc" name="task_desc" value="<?php echo htmlspecialchars($task['task_desc']); ?>" required>
                </div>
                <div>
